...
export function generateNormalMap(heightMap, strength = 1.0) {
...
export function generateRoughnessMap(heightMap, baseRoughness = 0.8) {
    const canvas = document.createElement('canvas');
    canvas.width = heightMap.width;
    canvas.height = heightMap.height;
    const ctx = canvas.getContext('2d');
...
export function generateMetallicMap(width, height, metallicValue = 0.0) {
    const canvas = document.createElement('canvas');
    canvas.width = width;
...
export function generateAmbientOcclusionMap(heightMap, radius = 4) {
    const canvas = document.createElement('canvas');
    canvas.width = heightMap.width;
    canvas.height = heightMap.height;
    const ctx = canvas.getContext('2d');
...
export function applyBlur(canvas, radius = 2) {
...
export function makeSeamless(canvas, blendSize = 32) {
