 ...
 */
export function generateStitch(stitchType, points, config) {
    // Validate input
 ...
 */
export function generateStitchPattern(stitchType, basePoints, config, patternOptions = {}) {
    const stitches = [];
    switch (stitchType) {
        case 'satin':
...
function generateSatinPattern(points, config, options) {
    const stitches = [];
...
function generateFillPattern(points, config, options) {
    const stitches = [];
...
function generateCrossStitchPattern(points, config, options) {
    const stitches = [];
...
function generateChainPattern(points, config, options) {
    const stitches = [];
...
function generateBackstitchPattern(points, config, options) {
    const stitches = [];
...
function generateFrenchKnotPattern(points, config, options) {
    const stitches = [];
...
function generateBullionPattern(points, config, options) {
    const stitches = [];
...
function generateLazyDaisyPattern(points, config, options) {
    const stitches = [];
...
function generateFeatherPattern(points, config, options) {
    const stitches = [];
