...
export class VectorEmbroideryIntegration {
    ...
    // EMBROIDERY HANDLING
    // ============================================================================
    handleEmbroideryMouseDown(event, point, shapes, currentPath) {
    ...
    handleEmbroideryMouseMove(event, point, shapes, currentPath) {
    ...
    handleEmbroideryMouseUp(event, point, shapes, currentPath) {
