...
const aiOptimizationTests = [
    ...
    },
    {
        ...
        test: async () => {
            ...
            const result = await aiSystem.optimizeRendering(context.settings, context);
            if (!result.success) {
        ...
        test: async () => {
            ...
            const stitchPath = {
                ...
                points: [
                    ...
                    { x: 200, y: 100, type: 'corner' },
                    { x: 200, y: 200, type: 'corner' },
...
const errorHandlingTests = [
    ...
    },
    {
        ...
        test: async () => {
            const errorId = errorHandling.reportError('Test error', { test: true }, 'system', 'info');
            if (!errorId) {
...
export function registerCoreSystemTests() {
