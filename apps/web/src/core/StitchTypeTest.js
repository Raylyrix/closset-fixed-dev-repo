...
export class StitchTypeTester {
     ...
     */
    async testStitchType(stitchType) {
        ...
        try {
            ...
            // Test rendering
            const success = universalVectorRenderer.render(this.ctx, testPoints, stitchType, config, { realTime: false, quality: 'high' });
     ...
     */
    async testStitchConfigurations(stitchType) {
        const results = [];
        ...
        for (const config of configurations) {
            ...
            try {
                ...
                const success = universalVectorRenderer.render(this.ctx, testPoints, stitchType, { type: stitchType, ...config }, { realTime: false, quality: 'high' });
                const endTime = performance.now();
                const renderTime = endTime - startTime;
                results.push({
     ...
     */
    async testPerformance(stitchType) {
        const results = [];
...
export async function testAllStitchTypes() {
    const tester = new StitchTypeTester();
    return await tester.testAllStitchTypes();
}
export async function testStitchType(stitchType) {
    const tester = new StitchTypeTester();
