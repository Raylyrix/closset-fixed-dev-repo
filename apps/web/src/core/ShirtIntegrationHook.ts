...
export interface UseShirtIntegrationOptions {
  // Integration options
...
export function useShirtIntegration(options: UseShirtIntegrationOptions = {}) {
  const [state, setState] = useState<ShirtIntegrationState>({
    isInitialized: false,
