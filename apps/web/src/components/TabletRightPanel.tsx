          ...
          <div onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{
                ...
                <span>Height</span>
                <span style={{ fontSize: '11px', color: '#999' }}>{puffHeight}</span>
              </div>
              <input
                type="range"
                min="0.1"
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{
                ...
                <span>Softness</span>
                <span style={{ fontSize: '11px', color: '#999' }}>{Math.round(puffSoftness * 100)}%</span>
              </div>
              <input
                type="range"
                min="0"
            ...
            <div style={{ marginBottom: '16px' }}>
              <div style={{
                ...
                <span>Opacity</span>
                <span style={{ fontSize: '11px', color: '#999' }}>{Math.round(puffOpacity * 100)}%</span>
              </div>
              <input
                type="range"
                min="0"
